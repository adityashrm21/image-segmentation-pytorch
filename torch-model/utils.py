...
def gen_test_output(n_class, testloader, model, test_paths):
    model.eval();
...
def save_inference_samples(output_dir, testloader, model, test_paths):
    print('Training Finished. Saving test images to: {}'.format(output_dir))
    image_outputs = gen_test_output(2, testloader, model, test_paths)
